...
export default function ChatStream({ messages = [], isLoading }) {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 py-2 space-y-3 w-full max-w-3xl mx-auto">
      ...
      {isLoading && (
        <div className="flex justify-start">
          <div className="bg-[#161f36] text-amber-300 border border-white/10 px-4 py-2 rounded-2xl rounded-bl-none text-xs flex items-center gap-2">
